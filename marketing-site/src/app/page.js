    ...
    <div className="flex flex-col items-center w-full">
      ...
      <section className="w-full max-w-5xl mx-auto px-6 pt-32 pb-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up" style={{ animationDelay: '0.3s' }}>
          <Link href={process.env.NEXT_PUBLIC_APP_URL || (process.env.NODE_ENV === 'development' ? "http://localhost:5173" : "https://frontend-two-ruby-40.vercel.app")} className="bg-white/5 border border-white/10 text-white px-6 py-3 rounded-lg font-medium flex items-center gap-2 hover:bg-white/10 transition-colors">
            Launch Platform
          </Link>
