      ...
      <body className="antialiased bg-grid-pattern min-h-screen flex flex-col">
        ...
        <nav className="sticky top-0 z-50 bg-[#050505]/80 backdrop-blur-md border-b border-white/10 px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href={process.env.NEXT_PUBLIC_APP_URL || (process.env.NODE_ENV === 'development' ? "http://localhost:5173" : "https://nethraai.vercel.app")} className="bg-white/5 border border-white/10 text-white px-4 py-2 rounded-md text-sm font-semibold flex items-center gap-2 hover:bg-white/10 transition-colors">
